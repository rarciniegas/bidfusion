...
--
-- Host: localhost
-- Generation Time: Apr 14, 2018 at 01:01 AM
...
INSERT INTO `Item` (`itemID`, `date_time`, `item_name`, `description`, `start_bid`, `reserve`, `ends_in`, `get_it_now`, `returnable`, `category`, `user_name`, `item_condition`) VALUES
  ...
  (3, '2018-04-02 09:19:48', 'Nikon D3', 'New and in box!', '1.00', '1800.00', '2018-04-05 09:19:48', '2.00', 0, 'Electronics', 'user2', 4),
...
--
ALTER TABLE `Item`
  MODIFY `itemID` int(16) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
